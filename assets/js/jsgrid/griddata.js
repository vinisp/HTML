  ...
  var db = {
    loadData: function (filter) {
      return $.grep(this.clients, function (client) {
        return (
          (!filter.Programa || client.Programa.indexOf(filter.Programa) > -1) &&
          (!filter.Municipio ||
            client.Municipio.indexOf(filter.Municipio) > -1) &&
          (!filter.Parceiros ||
            client.Parceiros.indexOf(filter.Parceiros) > -1) &&
          (!filter.Patrocinadores ||
            client.Patrocinadores.indexOf(filter.Municipio) > -1)
        );
      });
    },
